...
import { Container as BaseContainer, Row, Col } from "components/grid";
import {
  HeroHeading,
  SectionHeading as BaseHeading,
  Text as BaseText,
} from "components/typography";

const Container = (props) => <BaseContainer py={0} pt={6} pb={0} {...props} />;

const SectionHeading = (props) => <BaseHeading pb={3} {...props} />;

const Text = (props) => <BaseText pb={2} {...props} />;

const OrderedList = (props) => <Box as="ol" pl={3} {...props} />;
      ...
      <Row>
        <Col col={12}>
          ...
          <Text>
            ...
            данных Пашкова Екатерина Сергеевна (далее – Оператор).
          </Text>
          <OrderedList>
            <ListItem>
    ...
    <Container>
      <Row>
        <Col col={12}>
          ...
          <OrderedList>
            <ListItem>1. Фамилия, имя, отчество;</ListItem>
            <ListItem>2. Номера телефонов;</ListItem>
            <ListItem>
        ...
        <Col col={12}>
          ...
          <OrderedList>
            ...
            <ListItem>
              ...
              электронной почты mail@coinstory.pro с пометкой «Отказ от
        ...
        <Col col={12}>
          ...
          <OrderedList>
            <ListItem>
              ...
              https://coinstory.pro. Заполняя соответствующие формы и/или
        ...
        <Col col={12}>
          ...
          <OrderedList>
            ...
            <ListItem>
              ...
              Оператора mail@coinstory.pro с пометкой «Актуализация персональных
              данных».
            </ListItem>
            <ListItem>
              ...
              mail@coinstory.pro с пометкой «Отзыв согласия на обработку
              персональных данных».
            </ListItem>
          </OrderedList>
        </Col>
        ...
        <Col col={12}>
          ...
          <OrderedList>
            ...
            <ListItem>
              ...
              сети Интернет по адресу https://coinstory.pro.
            </ListItem>
          </OrderedList>
        </Col>
      </Row>
